...
const jobsData: Job[] = [
  {
    ...
    imageUrl: ad1,
    description: "We are hiring friendly and customer-focused Waiters/Waitresses for top-tier restaurants and hotels in Dubai. As part of the service team, you'll be responsible for delivering a seamless dining experience, taking orders, serving food, and ensuring guest satisfaction.",
    responsibilities: [
