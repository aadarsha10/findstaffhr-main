...
export default function FrameImage() {
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      {/* Top gradient fade */}
      <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-white to-transparent z-20"></div>

      <div className="relative w-full max-w-[650px] mt-10 h-auto group z-10">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-10  bg-gradient-to-t from-white via-white to-transparent z-20"></div>
    </div>
  );
}
